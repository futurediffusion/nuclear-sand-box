...
| EXC-SHOP-PORT-WRAPPER-001 | 2026-04-02 | N/A (higiene sprint temporal) | API legacy en `ShopService` (wrapper hacia `ShopPort`) | Compat API bridge | Retirado tras migrar `keeper_menu_ui.gd` al contrato final `ShopService.get_port()` y eliminar API legacy del wrapper. | Runtime-Commerce | 2026-04-15 | 2026-05-15 | 2026-04-02 |
